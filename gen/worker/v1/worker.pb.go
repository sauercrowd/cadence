...
type Task struct {
	...
	Agents         []*AgentSession        `protobuf:"bytes,16,rep,name=agents,proto3" json:"agents,omitempty"`
	AgentUpdates   []*AgentUpdate         `protobuf:"bytes,17,rep,name=agent_updates,json=agentUpdates,proto3" json:"agent_updates,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Task) GetAgents() []*AgentSession {
	if x != nil {
		return x.Agents
	}
	return nil
...
func (x *Task) GetAgentUpdates() []*AgentUpdate {
	if x != nil {
...
type AgentSession struct {
	...
	SubphaseNumber int32                  `protobuf:"varint,5,opt,name=subphase_number,json=subphaseNumber,proto3" json:"subphase_number,omitempty"`
...
func (x *AgentSession) GetScope() string {
	if x != nil {
		return x.Scope
	}
	return ""
...
func (x *AgentSession) GetPhaseId() string {
	if x != nil {
		return x.PhaseId
	}
	return ""
...
func (x *AgentSession) GetSubphaseNumber() int32 {
	if x != nil {
		return x.SubphaseNumber
	}
	return 0
}
...
func (x *AgentSession) GetLastSeen() *timestamppb.Timestamp {
	if x != nil {
		return x.LastSeen
	}
	return nil
...
func (x *AgentUpdate) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
func (x *AgentUpdate) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *AgentUpdate) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
func (x *AgentUpdate) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
type UpsertAgentSessionRequest struct {
	...
	SubphaseNumber int32                  `protobuf:"varint,6,opt,name=subphase_number,json=subphaseNumber,proto3" json:"subphase_number,omitempty"`
	Status         string                 `protobuf:"bytes,7,opt,name=status,proto3" json:"status,omitempty"`
	Update         string                 `protobuf:"bytes,8,opt,name=update,proto3" json:"update,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *UpsertAgentSessionRequest) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *UpsertAgentSessionRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *UpsertAgentSessionRequest) GetScope() string {
	if x != nil {
		return x.Scope
	}
	return ""
...
func (x *UpsertAgentSessionRequest) GetPhaseId() string {
	if x != nil {
		return x.PhaseId
	}
	return ""
...
func (x *UpsertAgentSessionRequest) GetSubphaseNumber() int32 {
	if x != nil {
		return x.SubphaseNumber
	}
	return 0
...
func (x *UpsertAgentSessionRequest) GetUpdate() string {
	if x != nil {
		return x.Update
	}
	return ""
...
const file_worker_v1_worker_proto_rawDesc = "" +
	...
	"\bfilename\x18\x03 \x01(\tR\bfilename\"\xbf\x05\n" +
	"\x04Task\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	...
	"\x05links\x18\x0f \x03(\v2\x14.worker.v1.PhaseLinkR\x05links\x12/\n" +
	"\x06agents\x18\x10 \x03(\v2\x17.worker.v1.AgentSessionR\x06agents\x12;\n" +
	"\ragent_updates\x18\x11 \x03(\v2\x16.worker.v1.AgentUpdateR\fagentUpdatesJ\x04\b\t\x10\n" +
	"\"\x84\x02\n" +
	...
	"\bphase_id\x18\x04 \x01(\tR\aphaseId\x12'\n" +
	"\x0fsubphase_number\x18\x05 \x01(\x05R\x0esubphaseNumber\x12\x16\n" +
	"\x06status\x18\x06 \x01(\tR\x06status\x127\n" +
	"\tlast_seen\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\blastSeen\x12\x16\n" +
	"\x06active\x18\b \x01(\bR\x06active\"\x93\x01\n" +
	"\vAgentUpdate\x12\x16\n" +
	"\x06number\x18\x01 \x01(\x05R\x06number\x12\x1d\n" +
	"\n" +
	"session_id\x18\x02 \x01(\tR\tsessionId\x12\x12\n" +
	"\x04body\x18\x03 \x01(\tR\x04body\x129\n" +
	"\n" +
	"created_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\xf1\x01\n" +
	"\x19UpsertAgentSessionRequest\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12\x1d\n" +
	"\n" +
	"session_id\x18\x02 \x01(\tR\tsessionId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x14\n" +
	"\x05scope\x18\x04 \x01(\tR\x05scope\x12\x19\n" +
	"\bphase_id\x18\x05 \x01(\tR\aphaseId\x12'\n" +
	"\x0fsubphase_number\x18\x06 \x01(\x05R\x0esubphaseNumber\x12\x16\n" +
	"\x06status\x18\a \x01(\tR\x06status\x12\x16\n" +
	"\x06update\x18\b \x01(\tR\x06update\"\x86\x01\n" +
	"\bSubphase\x12\x16\n" +
	...
	"\brevision\x18\x03 \x01(\tR\brevision\"\x98\x01\n" +
	"\x0fPhaseDefinition\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12+\n" +
	"\x11document_template\x18\x06 \x01(\tR\x10documentTemplate\x12\x16\n" +
	"\x06number\x18\t \x01(\x05R\x06numberJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\x05\x10\x06J\x04\b\a\x10\bJ\x04\b\b\x10\t\"z\n" +
	"\tTaskPhase\x12:\n" +
	"\n" +
	...
	"\x14AGENT_STATUS_WORKING\x10\x012\xc0\n" +
	"\n" +
	"\x10WorkspaceService\x12M\n" +
	"\x12UpsertAgentSession\x12$.worker.v1.UpsertAgentSessionRequest\x1a\x0f.worker.v1.Task\"\x00\x12E\n" +
...
var file_worker_v1_worker_proto_goTypes = []any{
	...
	(*AgentSession)(nil),              // 4: worker.v1.AgentSession
	(*AgentUpdate)(nil),               // 5: worker.v1.AgentUpdate
	(*UpsertAgentSessionRequest)(nil), // 6: worker.v1.UpsertAgentSessionRequest
	(*Subphase)(nil),                  // 7: worker.v1.Subphase
	(*CreateSubphaseRequest)(nil),     // 8: worker.v1.CreateSubphaseRequest
	(*UpdateSubphaseRequest)(nil),     // 9: worker.v1.UpdateSubphaseRequest
	(*PhaseLink)(nil),                 // 10: worker.v1.PhaseLink
	(*CreatePhaseLinkRequest)(nil),    // 11: worker.v1.CreatePhaseLinkRequest
	(*DeletePhaseLinkRequest)(nil),    // 12: worker.v1.DeletePhaseLinkRequest
	(*PhaseDefinition)(nil),           // 13: worker.v1.PhaseDefinition
	(*TaskPhase)(nil),                 // 14: worker.v1.TaskPhase
	(*Workflow)(nil),                  // 15: worker.v1.Workflow
	(*WorkspaceInfo)(nil),             // 16: worker.v1.WorkspaceInfo
	(*UpdateTaskRequest)(nil),         // 17: worker.v1.UpdateTaskRequest
	(*UpdateWorkflowRequest)(nil),     // 18: worker.v1.UpdateWorkflowRequest
	(*Document)(nil),                  // 19: worker.v1.Document
	(*ListTasksResponse)(nil),         // 20: worker.v1.ListTasksResponse
	(*CreateTaskRequest)(nil),         // 21: worker.v1.CreateTaskRequest
	(*TaskRequest)(nil),               // 22: worker.v1.TaskRequest
	(*RenameTaskRequest)(nil),         // 23: worker.v1.RenameTaskRequest
	(*CreateDocumentRequest)(nil),     // 24: worker.v1.CreateDocumentRequest
	(*DocumentRequest)(nil),           // 25: worker.v1.DocumentRequest
	(*RenameDocumentRequest)(nil),     // 26: worker.v1.RenameDocumentRequest
	(*UpdateDocumentRequest)(nil),     // 27: worker.v1.UpdateDocumentRequest
...
var file_worker_v1_worker_proto_depIdxs = []int32{
	...
	28, // 1: worker.v1.Task.created_at:type_name -> google.protobuf.Timestamp
	28, // 2: worker.v1.Task.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 3: worker.v1.Task.status:type_name -> worker.v1.TaskStatus
	1,  // 4: worker.v1.Task.agent_status:type_name -> worker.v1.AgentStatus
	14, // 5: worker.v1.Task.phases:type_name -> worker.v1.TaskPhase
	7,  // 6: worker.v1.Task.subphases:type_name -> worker.v1.Subphase
	10, // 7: worker.v1.Task.links:type_name -> worker.v1.PhaseLink
	4,  // 8: worker.v1.Task.agents:type_name -> worker.v1.AgentSession
	5,  // 9: worker.v1.Task.agent_updates:type_name -> worker.v1.AgentUpdate
	28, // 10: worker.v1.AgentSession.last_seen:type_name -> google.protobuf.Timestamp
	28, // 11: worker.v1.AgentUpdate.created_at:type_name -> google.protobuf.Timestamp
	13, // 12: worker.v1.TaskPhase.definition:type_name -> worker.v1.PhaseDefinition
	13, // 13: worker.v1.Workflow.phases:type_name -> worker.v1.PhaseDefinition
	0,  // 14: worker.v1.UpdateTaskRequest.status:type_name -> worker.v1.TaskStatus
	1,  // 15: worker.v1.UpdateTaskRequest.agent_status:type_name -> worker.v1.AgentStatus
	29, // 16: worker.v1.UpdateTaskRequest.update_mask:type_name -> google.protobuf.FieldMask
	15, // 17: worker.v1.UpdateWorkflowRequest.workflow:type_name -> worker.v1.Workflow
	3,  // 18: worker.v1.ListTasksResponse.tasks:type_name -> worker.v1.Task
	6,  // 19: worker.v1.WorkspaceService.UpsertAgentSession:input_type -> worker.v1.UpsertAgentSessionRequest
	8,  // 20: worker.v1.WorkspaceService.CreateSubphase:input_type -> worker.v1.CreateSubphaseRequest
	9,  // 21: worker.v1.WorkspaceService.UpdateSubphase:input_type -> worker.v1.UpdateSubphaseRequest
	11, // 22: worker.v1.WorkspaceService.CreatePhaseLink:input_type -> worker.v1.CreatePhaseLinkRequest
	12, // 23: worker.v1.WorkspaceService.DeletePhaseLink:input_type -> worker.v1.DeletePhaseLinkRequest
	30, // 24: worker.v1.WorkspaceService.GetWorkspace:input_type -> google.protobuf.Empty
	22, // 25: worker.v1.WorkspaceService.GetTask:input_type -> worker.v1.TaskRequest
	17, // 26: worker.v1.WorkspaceService.UpdateTask:input_type -> worker.v1.UpdateTaskRequest
	30, // 27: worker.v1.WorkspaceService.GetWorkflow:input_type -> google.protobuf.Empty
	18, // 28: worker.v1.WorkspaceService.UpdateWorkflow:input_type -> worker.v1.UpdateWorkflowRequest
	30, // 29: worker.v1.WorkspaceService.ListTasks:input_type -> google.protobuf.Empty
	21, // 30: worker.v1.WorkspaceService.CreateTask:input_type -> worker.v1.CreateTaskRequest
	23, // 31: worker.v1.WorkspaceService.RenameTask:input_type -> worker.v1.RenameTaskRequest
	22, // 32: worker.v1.WorkspaceService.DeleteTask:input_type -> worker.v1.TaskRequest
	24, // 33: worker.v1.WorkspaceService.CreateDocument:input_type -> worker.v1.CreateDocumentRequest
	25, // 34: worker.v1.WorkspaceService.GetDocument:input_type -> worker.v1.DocumentRequest
	26, // 35: worker.v1.WorkspaceService.RenameDocument:input_type -> worker.v1.RenameDocumentRequest
	27, // 36: worker.v1.WorkspaceService.UpdateDocument:input_type -> worker.v1.UpdateDocumentRequest
	25, // 37: worker.v1.WorkspaceService.DeleteDocument:input_type -> worker.v1.DocumentRequest
	3,  // 38: worker.v1.WorkspaceService.UpsertAgentSession:output_type -> worker.v1.Task
	3,  // 39: worker.v1.WorkspaceService.CreateSubphase:output_type -> worker.v1.Task
	3,  // 40: worker.v1.WorkspaceService.UpdateSubphase:output_type -> worker.v1.Task
	3,  // 41: worker.v1.WorkspaceService.CreatePhaseLink:output_type -> worker.v1.Task
	3,  // 42: worker.v1.WorkspaceService.DeletePhaseLink:output_type -> worker.v1.Task
	16, // 43: worker.v1.WorkspaceService.GetWorkspace:output_type -> worker.v1.WorkspaceInfo
	3,  // 44: worker.v1.WorkspaceService.GetTask:output_type -> worker.v1.Task
	3,  // 45: worker.v1.WorkspaceService.UpdateTask:output_type -> worker.v1.Task
	15, // 46: worker.v1.WorkspaceService.GetWorkflow:output_type -> worker.v1.Workflow
	15, // 47: worker.v1.WorkspaceService.UpdateWorkflow:output_type -> worker.v1.Workflow
	20, // 48: worker.v1.WorkspaceService.ListTasks:output_type -> worker.v1.ListTasksResponse
	3,  // 49: worker.v1.WorkspaceService.CreateTask:output_type -> worker.v1.Task
	3,  // 50: worker.v1.WorkspaceService.RenameTask:output_type -> worker.v1.Task
	30, // 51: worker.v1.WorkspaceService.DeleteTask:output_type -> google.protobuf.Empty
	19, // 52: worker.v1.WorkspaceService.CreateDocument:output_type -> worker.v1.Document
	19, // 53: worker.v1.WorkspaceService.GetDocument:output_type -> worker.v1.Document
	19, // 54: worker.v1.WorkspaceService.RenameDocument:output_type -> worker.v1.Document
	19, // 55: worker.v1.WorkspaceService.UpdateDocument:output_type -> worker.v1.Document
	30, // 56: worker.v1.WorkspaceService.DeleteDocument:output_type -> google.protobuf.Empty
